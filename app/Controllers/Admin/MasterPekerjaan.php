...
class MasterPekerjaan extends BaseController
{
    ...
    {
        $this->model      = new MasterPekerjaanModel();
        $this->validation = \Config\Services::validation();
    }

    public function index()
    {
        return view('admin/master_pekerjaan/index', [
    ...
    public function datatable()
    {
        ...
        $columns = [
            0 => 'id',             // index #
            1 => 'nama_pekerjaan', // Nama
            2 => 'kode_pekerjaan', // Kode
            3 => 'urut',           // Urut
            4 => 'is_active',      // Status
        ];
    ...
    public function save()
    {
        ...
        $data = [
            ...
            'kode_pekerjaan' => $this->request->getPost('kode_pekerjaan') ?: null,
        ...
        if ($id) {
            ...
            $msg = 'Data pekerjaan berhasil diperbarui.';
        } else {
            $this->model->insert($data);
            $msg = 'Data pekerjaan berhasil ditambahkan.';
        }

        return redirect()->to('admin/master-pekerjaan')
            ->with('success', $msg);
    }
