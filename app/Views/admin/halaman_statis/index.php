...
<script>
    $(function() {
        ...
        let table = $('#tablePages').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: baseUrl + '/admin/halaman-statis/datatable',
                type: 'POST',
                data: function(d) {
                    d[csrfName] = csrfHash;
                }
            ...
            columns: [{ // index
                ...
                { // actions
                    ...
                    searchable: false,
                    render: function(row) {
                        let editUrl = baseUrl + '/admin/halaman-statis/edit/' + row.id;
                        return `
        ...
        $('#tablePages').on('click', '.btnDelete', function() {
            let id = $(this).data('id');
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: baseUrl + '/admin/halaman-statis/delete',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        id: id,
                    ...
                    success: function(res) {
                        ...
                        if (res.status) {
                            Swal.fire({
                                icon: 'success',
                                title: 'Berhasil',
                                text: res.message || 'Halaman berhasil dihapus',
                                timer: 2000,
